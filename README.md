...
get the app created:
    ...
    $ heroku apps:create geekteek
    Creating geekteek... done, stack is cedar
    http://geekteek.herokuapp.com/ | git@heroku.com:geekteek.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://geekteek.herokuapp.com deployed to Heroku

    To git@heroku.com:geekteek.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://geekteek.herokuap.com
    ["Hello" :from Heroku]
